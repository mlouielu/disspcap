...
std::string DNS::parse_rdata(uint16_t type, uint16_t length)
{
    ...
    switch (type) {
        case 1:
            ...
            if (inet_ntop(AF_INET, &ipv4_addr, ipv4_buf, INET_ADDRSTRLEN) ==
                nullptr) {
                data = "INVALID IP";
            } else {
        ...
        case 28:
            ...
            /* convert ip */
            if (inet_ntop(AF_INET6, &ipv6_addr, ipv6_buf, INET6_ADDRSTRLEN) ==
                nullptr) {
                data = "INVALID IPv6";
            } else {
        ...
        case 48:
            ...
            data +=
                " " + this->parse_dnssec_algorithm(dnskey_ptr->algorithm) + " ";
